...
func CreateColumn(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
...
func CreateConstraint(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
...
func CreateTable(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
...
func CreateIndex(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
...
func AlterColumn(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
	if exists, err := ColumnExists(c, tx, args[0], args[1]); err != nil {
		return err
	} else if exists {
		return body.Invoke(c, tx)
...
func AlterConstraint(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
	if exists, err := ConstraintExists(c, tx, args[0]); err != nil {
		return err
	} else if exists {
		return body.Invoke(c, tx)
...
func AlterTable(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
	if exists, err := TableExists(c, tx, args[0]); err != nil {
		return err
	} else if exists {
		return body.Invoke(c, tx)
...
func AlterIndex(c *spiffy.DbConnection, tx *sql.Tx, body Invocable, args ...string) error {
	if exists, err := IndexExists(c, tx, args[0], args[1]); err != nil {
		return err
	} else if exists {
		return body.Invoke(c, tx)
